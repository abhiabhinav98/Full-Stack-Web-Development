                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" className="form-control" name="telnum" placeholder="telephone no."
                                    validators={{
                            ...
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" id="message" name="message" rows="12" className="from-control" >
